...
export default function RequestRecordsPage() {
  ...
  if (loading) return <div className={styles.page} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>Checking clinical session...</div>;
      ...
      <div className={styles.page}>
        ...
        <div className="container" style={{ maxWidth: '750px', paddingTop: '32px', paddingBottom: '80px' }}>
          ...
          <div className={styles.actions}>
            ...
            <button onClick={handleSend} className="btn btn-primary btn-lg" style={{ flex: 1 }} disabled={loading}>
