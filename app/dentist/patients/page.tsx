      ...
      <main style={{ flex: 1, marginLeft: '260px' }}>
        ...
        <div style={{ height: '64px', borderBottom: '1px solid #f1f5f9', display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 40px', background: '#fff', position: 'sticky', top: 0, zIndex: 90 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
             <div style={{ padding: '6px 12px', borderRadius: '6px', background: '#f8fafc', display: 'flex', alignItems: 'center', gap: '8px', fontSize: '0.8rem', border: '1px solid #f1f5f9', color: '#64748b' }}>
               <Search size={14} />
               <input placeholder="Search patient directory..." style={{ border: 'none', background: 'transparent', outline: 'none', width: '200px' }} />
             </div>
          </div>
        ...
        <div style={{ padding: '40px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: '48px' }}>
            <div>
              <h1 style={{ fontSize: '2rem', fontWeight: 800, letterSpacing: '-0.04em', marginBottom: '4px' }}>Patient Directory</h1>
              <p style={{ color: '#64748b', fontSize: '0.95rem' }}>Management of practice-wide patient identities.</p>
            </div>
          ...
          <div style={{ padding: '80px', textAlign: 'center', background: '#f8fafc', borderRadius: '24px', border: '1px solid #f1f5f9' }}>
            ...
            <h3 style={{ fontSize: '1.1rem', fontWeight: 800, color: '#0f172a', marginBottom: '8px' }}>Directory Synchronization</h3>
            <p style={{ color: '#64748b', maxWidth: '400px', margin: '0 auto 24px', fontSize: '0.9rem', lineHeight: 1.5 }}>Your practice's patient records are being migrated to the high-fidelity clinical archive.</p>
            <button className="btn btn-primary" style={{ padding: '10px 24px', borderRadius: '8px', fontWeight: 800, fontSize: '0.85rem' }}>Add Patient Profile</button>
          </div>
        </div>
      </main>
    </div>
